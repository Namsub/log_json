...
do
	...
	python parsing_trace_format.py --json_file=/home/titanxp/log_json/[share]_batch_${i}_layer_2_unit_128_[1-1]_de-en_trace_3.json --output_dir=/home/titanxp/log_json/[share]_batch_${i}_layer_2_unit_128_[1-1]_de-en_trace_3.xlsx
done
END
...
for ((i=4;i<=8;i=i*2))
do
	python parsing_trace_format.py --json_file=${path}/batch_32_layer_${i}_unit_128_[1-1]_de-en_trace_3.json --output_dir=/home/titanxp/log_json/batch_32_layer_${i}_unit_128_[1-1]_de-en_trace_3.xlsx
...
do
	python parsing_trace_format.py --json_file=${path}/batch_32_layer_2_unit_${i}_[1-1]_de-en_trace_3.json --output_dir=/home/titanxp/log_json/batch_32_layer_2_unit_${i}_[1-1]_de-en_trace_3.xlsx
...
abc=${path}/batch_32_layer_2_unit_128_[6_1]_de-en_trace_3.json

cp ${abc} /home/titanxp/log_json/
echo "done"
#END
